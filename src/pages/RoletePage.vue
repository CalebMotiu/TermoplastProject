...
const handleSaveEdit = () => {
  store.editeazaRoleta(editingId.value, {
...
<template>
  <div class="bg-gradient-to-b from-slate-700 to-slate-400 grow pb-10">
    <div class="flex justify-center mt-8 text-xl sm:text-4xl font-bold">Rolete</div>
